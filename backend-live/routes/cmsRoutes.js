...
import {
  ...
  messageController,
  statsCardController,
  footerCardController,
  trustedLogoController,
...
router.use("/stats-cards", createCrudRoutes(statsCardController));
router.use("/footer-cards", createCrudRoutes(footerCardController));
router.use("/trusted-logos", createCrudRoutes(trustedLogoController));
