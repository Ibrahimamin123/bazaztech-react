          ...
          <div className="row g-3">
            ...
            <div className="col-md-4">
              ...
              <small className="text-muted d-block mt-1" style={{ whiteSpace: "pre-line" }}>
                ...
                {"\n"}Recommended Dimensions: 400 × 120 px
                {"\n"}Width: 400 px
                {"\n"}Height: 120 px
              </small>
            ...
            <div className="col-md-6">
              <label className="form-label">Founder Video URL (YouTube)</label>
              <input
                className="form-control"
              ...
              <small className="text-muted d-block mt-1">
                Shown in the "A Note from Our Founder" popup on the homepage hero.
              </small>
            </div>
            <div className="col-md-6">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="https://www.youtube.com/@BazazTech"
              />
              <small className="text-muted d-block mt-1">
                Where the "Watch on YouTube" button takes visitors. Leave blank to link the video itself.
              </small>
            </div>
          </div>
